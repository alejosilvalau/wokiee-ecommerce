			...
			<div className='sort-filter'>
				...
				<div className='itemShow'>
					...
					<select name='' id='itemShow' onChange={handleSelectChange}>
						<option value='8' selected={curPerPage == 8 ? true : false}>
							8
						</option>
						<option value='12' selected={curPerPage == 12 ? true : false}>
							12
						</option>
						<option value='16' selected={curPerPage == 16 ? true : false}>
							16
						</option>
						<option value='20' selected={curPerPage == 20 ? true : false}>
							20
						</option>
					</select>
				</div>
							...
							<Text>
								<ul>
									...
									<li className='category-link'>
										<Link
											to={"/products?cat=men"}
											onClick={() => handleLinkClick("/products?cat=men")}
										>
											Men
										</Link>
									</li>
									<li className='category-link'>
										<Link
											...
											onClick={() => handleLinkClick("/products?cat=women")}
										>
											Women
										</Link>
									</li>
									<li className='category-link'>
										<Link
											to={"/products?cat=boys"}
											onClick={() => handleLinkClick("/products?cat=boys")}
										>
											Boys
										</Link>
									</li>
									<li className='category-link'>
										<Link
											to={"/products?cat=girls"}
											onClick={() => handleLinkClick("/products?cat=girls")}
										>
											Girls
										</Link>
									</li>
									<li className='category-link'>
										<Link
											...
											onClick={() =>
												handleLinkClick("/products?cat=accessories")
											}
										>
											Accessories
										</Link>
						...
						<Collapse title='FILTER BY PRICE' style={{ display: "block" }}>
							<Text>
								<ul>
									<li className='category-link'>
										<Link
											to={"/products?price=50"}
											onClick={() =>
												handleLinkClick("/products?pricel=0&&priceh=50")
											}
										>
											USD $0-$50
										</Link>
									...
									<li className='category-link'>
										<Link
											to={"/products?price=100"}
											onClick={() =>
												handleLinkClick("/products?pricel=50&&priceh=100")
											}
										>
											USD $50-$100
										</Link>
									...
									<li className='category-link'>
										<Link
											to={"/products?price=150"}
											onClick={() =>
												handleLinkClick("/products?pricel=100&&priceh=150")
											}
										>
											USD $100-$150
										</Link>
									...
									<li className='category-link'>
										<Link
											to={"/products?price=200"}
											onClick={() =>
												handleLinkClick("/products?pricel=150&&priceh=200")
											}
										>
											USD $150-$200
										</Link>
									...
									<li className='category-link'>
										<Link
											to={"/products?price=250"}
											onClick={() =>
												handleLinkClick("/products?pricel=200&&priceh=250")
											}
										>
											USD $200-$250
										</Link>
